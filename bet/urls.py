...
urlpatterns = [
    ...
    path("bet/create-from-model/<int:pb_id>/", views.create_bet_from_model, name="create_bet_from_model"),
    path('post-status/', views.post_status, name='post-data-stats'),
    path('matches/<int:match_id>/snapshots/', views.match_snapshots, name='match_snapshots'),
